...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__attributeTarget(ModuleDecl)\n")
SLANG_RAW("attribute_syntax [ExperimentalModule] : ExperimentalModuleAttribute;\n")
SLANG_RAW("\n")
...
SLANG_RAW("[sealed]\n")
SLANG_RAW("[builtin]\n")
SLANG_RAW("interface __BuiltinArithmeticType : __BuiltinType, IArithmetic, ICoopElement\n")
SLANG_RAW("{\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_SPLICE( (int)KnownBuiltinDeclName::IDifferentiable
)
SLANG_RAW(")]\n")
SLANG_RAW("interface IDifferentiable\n")
SLANG_RAW("{\n")
...
SLANG_RAW("[KnownBuiltin(")
SLANG_SPLICE( (int)KnownBuiltinDeclName::IDifferentiablePtr
)
SLANG_RAW(")]\n")
SLANG_RAW("interface IDifferentiablePtrType\n")
SLANG_RAW("{\n")
...
SLANG_RAW("[sealed]\n")
SLANG_RAW("[builtin]\n")
SLANG_RAW("interface ICoopElement\n")
SLANG_RAW("{\n")
...
SLANG_RAW("[sealed]\n")
SLANG_RAW("[builtin]\n")
SLANG_RAW("interface IFloatingPointCoopElement : ICoopElement\n")
SLANG_RAW("{\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("[builtin]\n")
SLANG_RAW("[TreatAsDifferentiable]\n")
SLANG_RAW("interface __BuiltinFloatingPointType : __BuiltinRealType, IFloat, IFloatingPointCoopElement\n")
SLANG_RAW("{\n")
...
SLANG_RAW("__generic<T, let N : int, let M : int> __intrinsic_op(select) matrix<T,N,M> __hlsl_select(matrix<bool,N,M> condition, matrix<T,N,M> ifTrue, matrix<T,N,M> ifFalse);\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T, let N : int, let M : int>\n")
SLANG_RAW("matrix<T,N,M> select(matrix<bool,N,M> condition, matrix<T,N,M> ifTrue, matrix<T,N,M> ifFalse)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case hlsl:\n")
SLANG_RAW("        return __hlsl_select(condition, ifTrue, ifFalse);\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        matrix<T,N,M> result;\n")
SLANG_RAW("        [[unroll]]\n")
SLANG_RAW("        for (uint32_t i = 0; i < N; i++)\n")
SLANG_RAW("            result[i] = select(condition[i], ifTrue[i], ifFalse[i]);\n")
SLANG_RAW("        return result;\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T, let N : int, let M : int>\n")
SLANG_RAW("matrix<T,N,M> operator?:(matrix<bool,N,M> condition, matrix<T,N,M> ifTrue, matrix<T,N,M> ifFalse)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return select(condition, ifTrue, ifFalse);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[__unsafeForceInlineEarly]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// Cast between any two floating point types, including substandard floating point types\n")
SLANG_RAW("// like FloatE4M3, FloatE5M2, BFloat16, etc.\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_FloatCast
)
SLANG_RAW(")\n")
SLANG_RAW("T floatCast<T:IFloatingPointCoopElement, U:IFloatingPointCoopElement>(U val);\n")
SLANG_RAW("\n")
...
{
SLANG_RAW("#line 1044 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 1056 \"core.meta.slang\"")
SLANG_RAW("\n")
...
SLANG_RAW("#line 1068 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("    ,  __BuiltinSignedArithmeticType\n")
...
SLANG_RAW("#line 1099 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("{\n")
...
SLANG_RAW("#line 1130 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("    ")
SLANG_SPLICE(attrib
)
...
SLANG_RAW("\n")
    ...
    {
    case BaseType::Bool:
SLANG_RAW("#line 1143 \"core.meta.slang\"")
SLANG_RAW("\n")
...
SLANG_RAW(") This not();\n")
    ...
    case BaseType::IntPtr:
    case BaseType::UIntPtr:
SLANG_RAW("#line 1168 \"core.meta.slang\"")
SLANG_RAW("\n")
...
SLANG_RAW(") uint64_t toUInt64();\n")
    ...
    case BaseType::Float:
    case BaseType::Double:
SLANG_RAW("#line 1223 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("        [Differentiable]\n")
SLANG_RAW("        static ")
SLANG_SPLICE(kBaseTypes[tt].name
...
SLANG_RAW(") float toFloat();\n")
SLANG_RAW("         [__unsafeForceInlineEarly] This scale<T:__BuiltinFloatingPointType>(T s) { return __mul(this, __realCast<This>(s)); }\n")
SLANG_RAW("        typedef ")
SLANG_SPLICE(kBaseTypes[tt].name
)
...
SLANG_RAW("        }\n")
    ...
    if( kBaseTypes[tt].tag == BaseType::Void )
    {
SLANG_RAW("#line 1271 \"core.meta.slang\"")
SLANG_RAW("\n")
...
SLANG_RAW("#line 1280 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 1289 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("//@hidden:\n")
SLANG_RAW("__magic_type(NullPtrType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_RawPointerType
)
SLANG_RAW(")\n")
...
SLANG_RAW("__magic_enum(AddressSpace)\n")
SLANG_RAW("enum AddressSpace : uint64_t\n")
SLANG_RAW("{\n")
SLANG_RAW("    Device = ")
...
SLANG_SPLICE((uint64_t)AddressSpace::GroupShared
)
SLANG_RAW(",\n")
SLANG_RAW("    VaryingInput = ")
SLANG_SPLICE((uint64_t)AddressSpace::Input
)
SLANG_RAW(",\n")
SLANG_RAW("};\n")
SLANG_RAW("\n")
SLANG_RAW("/// @category misc_types\n")
SLANG_RAW("__magic_enum(MemoryScope)\n")
SLANG_RAW("enum MemoryScope : int32_t\n")
SLANG_RAW("{\n")
SLANG_RAW("    CrossDevice = ")
SLANG_SPLICE((int32_t)MemoryScope::CrossDevice
)
SLANG_RAW(",\n")
SLANG_RAW("    Device = ")
SLANG_SPLICE((int32_t)MemoryScope::Device
)
SLANG_RAW(",\n")
SLANG_RAW("    Workgroup = ")
SLANG_SPLICE((int32_t)MemoryScope::Workgroup
)
SLANG_RAW(",\n")
SLANG_RAW("    Subgroup = ")
SLANG_SPLICE((int32_t)MemoryScope::Subgroup
)
SLANG_RAW(",\n")
SLANG_RAW("    Invocation = ")
SLANG_SPLICE((int32_t)MemoryScope::Invocation
)
SLANG_RAW(",\n")
SLANG_RAW("    QueueFamily = ")
SLANG_SPLICE((int32_t)MemoryScope::QueueFamily
)
SLANG_RAW(",\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("/// @category misc_types\n")
SLANG_RAW("/// Describes the access permissions for a pointer type.\n")
SLANG_RAW("__magic_enum(AccessQualifier)\n")
SLANG_RAW("enum Access : uint64_t\n")
SLANG_RAW("{\n")
SLANG_RAW("    /// The data maybe read and modified through the pointer. This is the default access qualifier\n")
SLANG_RAW("    /// for a pointer type.\n")
SLANG_RAW("    ReadWrite = ")
SLANG_SPLICE((uint64_t)AccessQualifier::ReadWrite
)
SLANG_RAW(",\n")
SLANG_RAW("\n")
SLANG_RAW("    /// The data being pointed to by a pointer can only be read through the pointer.\n")
SLANG_RAW("    /// This is to be distinguished from `Immutable`, which means the data being pointed to\n")
SLANG_RAW("    /// won't be changed by any means. In contrast, data pointed to by a `Read` pointer\n")
SLANG_RAW("    /// may still be changed through another pointer that is not read-only.\n")
SLANG_RAW("    /// This means that a pointer with `Read` access is meaningful only to the front-end\n")
SLANG_RAW("    /// type system, and is not expected to provide any optimization opportunities to\n")
SLANG_RAW("    /// the back-end.\n")
SLANG_RAW("    Read = ")
SLANG_SPLICE((uint64_t)AccessQualifier::Read
)
SLANG_RAW(",\n")
SLANG_RAW("\n")
SLANG_RAW("    /// The data being pointed to by a pointer is known to be immutable and won't\n")
SLANG_RAW("    /// be changed by any means during the execution of the program. It is UB if\n")
SLANG_RAW("    /// the data is changed during the program execution. This is a stronger\n")
SLANG_RAW("    /// qualifier than `Read`, and may allow the backend to perform more aggressive\n")
SLANG_RAW("    /// optimizations.\n")
SLANG_RAW("    Immutable = ")
SLANG_SPLICE((uint64_t)AccessQualifier::Immutable
)
SLANG_RAW(",\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    T,\n")
SLANG_RAW("    Access access = Access.ReadWrite,\n")
SLANG_RAW("    AddressSpace addrSpace = AddressSpace.Device>\n")
SLANG_RAW("{\n")
SLANG_RAW("    // A user is allowed to explicitly cast between any pointer type of\n")
SLANG_RAW("    // the same address space\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_BitCast
)
SLANG_RAW(")\n")
SLANG_RAW("    __init<U, Access accessOther>(Ptr<U, accessOther, addrSpace> ptr);\n")
SLANG_RAW("\n")
SLANG_RAW("    __intrinsic_op(")
...
SLANG_RAW("    __init(int64_t val);\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Subscript a pointer to get a reference to a value.\n")
SLANG_RAW("    ///\n")
SLANG_RAW("    /// The pointer must reference a memory location where\n")
SLANG_RAW("    /// N >= 0 values of type `T` are stored sequentially,\n")
SLANG_RAW("    /// in a layout consistent with an array `T[N]`;\n")
SLANG_RAW("    /// otherwise, this operation has undefined behavior.\n")
SLANG_RAW("    ///\n")
SLANG_RAW("    /// The `index` parameter must satisfy 0 <= `index` <= N;\n")
SLANG_RAW("    /// otherwise, this operation has undefined behavior.\n")
SLANG_RAW("    ///\n")
...
SLANG_RAW("    {\n")
SLANG_RAW("        //\n")
SLANG_RAW("        // TODO(tfoley): The `Ptr` type's subscript operation\n")
SLANG_RAW("        // currently provides a `ref` accessor (which returns a\n")
SLANG_RAW("        // reference that can be used for reading or writing),\n")
SLANG_RAW("        // independent of the `Access` that is specified by the\n")
SLANG_RAW("        // generic arguments  of a particular pointer type. In\n")
SLANG_RAW("        // practice, this means that subscripting a read-only\n")
SLANG_RAW("        // pointer yields a readable *and* writable reference.\n")
SLANG_RAW("        //\n")
SLANG_RAW("        // Previous versions of the code module attempted to\n")
SLANG_RAW("        // address the problem by providing a `get` accessor\n")
SLANG_RAW("        // on all platforms, and then use an `extension` to\n")
SLANG_RAW("        // introduce a `ref` accessor only to pointers that\n")
SLANG_RAW("        // are known to be mutable. That approach does not work,\n")
SLANG_RAW("        // however, because it is necessary that subscripting\n")
SLANG_RAW("        // a pointer yields a reference (l-value), whether or not\n")
SLANG_RAW("        // the reference is read-only.\n")
SLANG_RAW("        //\n")
SLANG_RAW("        // A different solution to the problem is needed, whether\n")
SLANG_RAW("        // by splitting up read-only and read-write pointers as\n")
SLANG_RAW("        // distinct types (as many languages do), or by allowing\n")
SLANG_RAW("        // the subscript operation to explicitly return a reference\n")
SLANG_RAW("        // with the same access as the pointer itself.\n")
SLANG_RAW("        //\n")
SLANG_RAW("\n")
SLANG_RAW("        __intrinsic_op(")
...
SLANG_RAW("};\n")
SLANG_RAW("\n")
SLANG_RAW("/// Represents a pointer to immutable data. Immutable data is known at compile time to remain unchanged during the entire\n")
SLANG_RAW("/// execution of the program. This knowledge allows the compiler to perform more aggressive optimizations around the memory\n")
SLANG_RAW("/// accesses through such pointers. If the data is changed during the program execution, the behavior is undefined and loaded\n")
SLANG_RAW("/// data through such pointers may be invalid.\n")
SLANG_RAW("typealias ImmutablePtr<T, AddressSpace addrSpace = AddressSpace.Device> = Ptr<T, Access.Immutable, addrSpace>;\n")
SLANG_RAW("\n")
SLANG_RAW("//@hidden:\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("internal int __align_attr(int alignment);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Load
)
SLANG_RAW(")\n")
SLANG_RAW("internal T __load_aligned<T>(T* ptr, int alignmentAttr);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Store
)
SLANG_RAW(")\n")
SLANG_RAW("internal void __store_aligned<T>(T* ptr, T value, int alignmentAttr);\n")
SLANG_RAW("\n")
SLANG_RAW("//@public:\n")
SLANG_RAW("\n")
...
SLANG_RAW("//@hidden:\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_MemoryScopeAttr
)
SLANG_RAW(")\n")
SLANG_RAW("internal int __memoryscope_attr(MemoryScope scope);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Load
)
SLANG_RAW(")\n")
SLANG_RAW("internal T __load_coherent<T, Access access, AddressSpace addrSpace>(Ptr<T, access, addrSpace> ptr, int alignmentAttr, int memoryScopeAttr);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Store
)
SLANG_RAW(")\n")
SLANG_RAW("internal void __store_coherent<T, AddressSpace addrSpace>(Ptr<T, Access::ReadWrite, addrSpace> ptr, T value, int alignmentAttr, int memoryScopeAttr);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Store a value coherently to a memoryscope.\n")
SLANG_RAW("/// Tighter memory scopes may be faster to operate on.\n")
SLANG_RAW("/// @param ptr The pointer to store value to.\n")
SLANG_RAW("/// @param value The value to store.\n")
SLANG_RAW("///\n")
SLANG_RAW("[require(SPV_KHR_vulkan_memory_model)]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("__generic<int alignment, MemoryScope scope, T, AddressSpace addrSpace>\n")
SLANG_RAW("void storeCoherent(Ptr<T, Access::ReadWrite, addrSpace> ptr, T value)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __store_coherent<T, addrSpace>(ptr, value, __align_attr(alignment), __memoryscope_attr(scope));\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("/// Load a value coherently to a memoryscope.\n")
SLANG_RAW("/// Tighter memory scopes may be faster to operate on.\n")
SLANG_RAW("/// @param ptr The pointer to load from.\n")
SLANG_RAW("///\n")
SLANG_RAW("[require(SPV_KHR_vulkan_memory_model)]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[__NoSideEffect]\n")
SLANG_RAW("__generic<int alignment, MemoryScope scope, T, Access access, AddressSpace addrSpace>\n")
SLANG_RAW("T loadCoherent(Ptr<T, access, addrSpace> ptr)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return __load_coherent<T, access, addrSpace>(ptr, __align_attr(alignment), __memoryscope_attr(scope));\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 1514 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("//@hidden:\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Load
...
SLANG_RAW(")\n")
SLANG_RAW("T __load<")
SLANG_SPLICE(ptrTypeParameterList
)
SLANG_RAW(">(")
SLANG_SPLICE(fullPtrType
)
SLANG_RAW(" ptr);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(" __getElementPtr<")
SLANG_SPLICE(ptrTypeParameterList
)
SLANG_RAW(", TIndex : __BuiltinIntegerType>(")
SLANG_SPLICE(fullPtrType
)
SLANG_RAW(" ptr, TIndex index);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_GetOffsetPtr
)
...
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("// Packed float types.\n")
SLANG_RAW("\n")
SLANG_RAW("/// Represent a 8-bit floating point value with 4 bits of exponent and 3 bits of mantissa.\n")
SLANG_RAW("[require(spvFloat8EXT)]\n")
SLANG_RAW("[require(cuda_sm_8_0)]\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_FloatE4M3Type
)
SLANG_RAW(")\n")
SLANG_RAW("__magic_type(FloatE4M3Type)\n")
SLANG_RAW("struct FloatE4M3 : IFloatingPointCoopElement\n")
SLANG_RAW("{\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_CastIntToFloat
)
...
SLANG_RAW(")\n")
SLANG_RAW("    __generic<U:IFloatingPointCoopElement>\n")
SLANG_RAW("    __init(U val);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("/// Represent a 8-bit floating point value with 5 bits of exponent and 2 bits of mantissa.\n")
SLANG_RAW("[require(spvFloat8EXT)]\n")
SLANG_RAW("[require(cuda_sm_8_0)]\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_FloatE5M2Type
)
SLANG_RAW(")\n")
SLANG_RAW("__magic_type(FloatE5M2Type)\n")
SLANG_RAW("struct FloatE5M2 : IFloatingPointCoopElement\n")
SLANG_RAW("{\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_CastIntToFloat
)
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("/// Represent a 16-bit floating point value with 8 bits of exponent and 7 bits of mantissa.\n")
SLANG_RAW("[require(spvBFloat16KHR)]\n")
SLANG_RAW("[require(cuda_sm_8_0)]\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_BFloat16Type
)
SLANG_RAW(")\n")
SLANG_RAW("__magic_type(BFloat16Type)\n")
SLANG_RAW("struct BFloat16 : IFloatingPointCoopElement\n")
SLANG_RAW("{\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_CastIntToFloat
)
...
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("extension<T:__BuiltinFloatingPointType> T\n")
SLANG_RAW("{\n")
SLANG_RAW("    [OverloadRank(-5)]\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_FloatCast
)
SLANG_RAW(")\n")
SLANG_RAW("    __init(FloatE4M3 val);\n")
SLANG_RAW("\n")
SLANG_RAW("    [OverloadRank(-5)]\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_FloatCast
...
SLANG_RAW(")\n")
SLANG_RAW("    __init(FloatE5M2 val);\n")
SLANG_RAW("\n")
SLANG_RAW("    [OverloadRank(-5)]\n")
SLANG_RAW("    __intrinsic_op(")
SLANG_SPLICE(kIROp_FloatCast
...
SLANG_RAW(")\n")
SLANG_RAW("    __init(BFloat16 val);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("//@hidden:\n")
SLANG_RAW("\n")
SLANG_RAW("// TODO(tfoley): This should really map over to `kIROp_PtrType`,\n")
SLANG_RAW("// but is currently still mapping to the IR opcode used for `ref`\n")
SLANG_RAW("// parameters.\n")
SLANG_RAW("//\n")
SLANG_RAW("__magic_type(ExplicitRefType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_RefParamType
)
SLANG_RAW(")\n")
...
SLANG_RAW("{};\n")
SLANG_RAW("\n")
SLANG_RAW("__magic_type(OutParamType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_OutParamType
)
SLANG_RAW(")\n")
SLANG_RAW("struct OutParam<T>\n")
SLANG_RAW("{};\n")
SLANG_RAW("\n")
SLANG_RAW("__magic_type(BorrowInOutParamType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_BorrowInOutParamType
)
SLANG_RAW(")\n")
SLANG_RAW("struct BorrowInOutParam<T>\n")
SLANG_RAW("{};\n")
SLANG_RAW("\n")
SLANG_RAW("__magic_type(RefParamType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_RefParamType
)
SLANG_RAW(")\n")
SLANG_RAW("struct RefParam<T>\n")
SLANG_RAW("{};\n")
SLANG_RAW("\n")
SLANG_RAW("__magic_type(BorrowInParamType)\n")
SLANG_RAW("__intrinsic_type(")
SLANG_SPLICE(kIROp_BorrowInParamType
)
SLANG_RAW(")\n")
SLANG_RAW("struct BorrowInParam<T>\n")
SLANG_RAW("{};\n")
SLANG_RAW("\n")
SLANG_RAW("// __Addr<T> is AddressSpace::Generic since Slang will specalize & validate the address-space\n")
SLANG_RAW("// internally to a concrete address-space.\n")
SLANG_RAW("typealias __Addr<T> = Ptr<T, Access::ReadWrite, (AddressSpace)")
...
SLANG_RAW(")\n")
SLANG_RAW("struct Optional : IDefaultInitializable\n")
SLANG_RAW("{\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__magic_type(ConditionalType)\n")
SLANG_RAW("struct Conditional<T, bool hasValue>\n")
SLANG_RAW("{\n")
SLANG_RAW("    internal vector<T, hasValue ? 1 : 0> storage;\n")
SLANG_RAW("\n")
SLANG_RAW("    __implicit_conversion(")
SLANG_SPLICE(kConversionCost_ValToOptional
)
SLANG_RAW(")\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    __init(T val) { if (hasValue) storage[0] = val;}\n")
SLANG_RAW("\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    public Optional<T> get()\n")
SLANG_RAW("    {\n")
SLANG_RAW("        if (hasValue)\n")
SLANG_RAW("        {\n")
SLANG_RAW("            return Optional<T>(storage[0]);\n")
SLANG_RAW("        }\n")
SLANG_RAW("        else\n")
SLANG_RAW("        {\n")
SLANG_RAW("            return none;\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    [mutating]\n")
SLANG_RAW("    public void set(T value)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        if (hasValue)\n")
SLANG_RAW("            storage[0] = value;\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("extension<T> Optional<T>\n")
SLANG_RAW("{\n")
SLANG_RAW("    __implicit_conversion(")
SLANG_SPLICE(kConversionCost_ImplicitDereference
)
SLANG_RAW(")\n")
SLANG_RAW("    __generic<bool condHasValue>\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    __init(Conditional<T, condHasValue> condVal)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        if (condHasValue)\n")
SLANG_RAW("            this = Optional<T>(condVal.storage[0]);\n")
SLANG_RAW("        else\n")
SLANG_RAW("            this = none;\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        case llvm:\n")
SLANG_RAW("            Ptr<int8_t> str = Ptr<int8_t>(getBuffer());\n")
SLANG_RAW("            int len = 0;\n")
SLANG_RAW("            while(str[len] != 0)\n")
SLANG_RAW("                len++;\n")
SLANG_RAW("            return len;\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    [require(cpp_llvm)]\n")
...
SLANG_RAW("        case llvm: __intrinsic_asm \"ret $0\";\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
...
SLANG_RAW("};\n")
SLANG_RAW("\n")
SLANG_RAW("extension<Access access> Ptr<void, access>\n")
SLANG_RAW("{\n")
SLANG_RAW("    __implicit_conversion(")
...
SLANG_RAW(")\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    __init(NativeString nativeStr) { this = Ptr<void, access>(nativeStr.getBuffer()); }\n")
SLANG_RAW("\n")
SLANG_RAW("    __generic<")
SLANG_SPLICE(ptrTypeParameterList
)
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("extension<T:IFloatingPointCoopElement, let N : int> vector<T,N>\n")
SLANG_RAW("{\n")
SLANG_RAW("    [OverloadRank(-1)]\n")
SLANG_RAW("    __implicit_conversion(")
SLANG_SPLICE(kConversionCost_Default
...
SLANG_RAW(") This neg();\n")
SLANG_RAW("    [__unsafeForceInlineEarly] This scale<T1:__BuiltinFloatingPointType>(T1 s) { return this.mul(__realCast<T>(s)); }\n")
...
SLANG_RAW(") This neg();\n")
SLANG_RAW("    [TreatAsDifferentiable][__unsafeForceInlineEarly] This scale<T1:__BuiltinFloatingPointType>(T1 s) { return this.mul(__realCast<T>(s)); }\n")
...
SLANG_RAW("#line 2516 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("//@ public:\n")
SLANG_RAW("\n")
...
SLANG_RAW("        }\n")
SLANG_RAW("\n")
SLANG_RAW("        // If a 'OutputIndices[index]' is referred to by a '__ref', call 'kIROp_MeshOutputRef(index)'\n")
SLANG_RAW("        [require(glsl_hlsl_metal_spirv, meshshading)]\n")
SLANG_RAW("        __intrinsic_op(")
SLANG_SPLICE(kIROp_MeshOutputRef
)
...
SLANG_RAW("#line 2757 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("//@hidden:\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW("#line 2862 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("// Only ReadWrite is an L-value.\n")
SLANG_RAW("__generic<T, Access access, AddressSpace addrSpace>\n")
SLANG_RAW("__intrinsic_op(0)\n")
SLANG_RAW("__prefix Ref<T, access, addrSpace> operator*(Ptr<T, access, addrSpace> value);\n")
SLANG_RAW("\n")
SLANG_RAW("// TODO: [require(cpu)]. This cannot be done yet since this change breaks slangpy\n")
SLANG_RAW("__generic<T>\n")
SLANG_RAW("__intrinsic_op(0)\n")
SLANG_RAW("[KnownBuiltin( ")
SLANG_SPLICE((int)KnownBuiltinDeclName::OperatorAddressOf
)
SLANG_RAW(")]\n")
SLANG_RAW("[require(cpp_cuda_spirv_llvm)]\n")
SLANG_RAW("__prefix Ptr<T, Access::ReadWrite, AddressSpace::Device> operator&(__ref T value);\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<")
SLANG_SPLICE(ptrTypeParameterList
)
SLANG_RAW(", TInt : __BuiltinIntegerType>\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_GetOffsetPtr
)
SLANG_RAW(")\n")
...
{
SLANG_RAW("#line 2926 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 3098 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("#line 3193 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("    __generic<T : ")
...
SLANG_RAW("#line 3238 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("//@ public:\n")
SLANG_RAW("\n")
...
SLANG_RAW("__generic<T>\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[require(cpp_cuda_llvm)]\n")
SLANG_RAW("int __sizeOf()\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case cpp: __intrinsic_asm \"sizeof($[0])\", T;\n")
SLANG_RAW("    case cuda: __intrinsic_asm \"sizeof($[0])\", T;\n")
SLANG_RAW("    case llvm: __intrinsic_asm \"ret i32 $[S0]\", T;\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
...
SLANG_RAW("    case llvm: __intrinsic_asm \"ret i32 $S0\";\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
...
SLANG_RAW("    case cuda :\n")
SLANG_RAW("    case cpp :\n")
SLANG_RAW("        __intrinsic_asm \"alignof($[0])\", T;\n")
SLANG_RAW("    case llvm:\n")
SLANG_RAW("        return __sizeOf<Tuple<int8_t, T> >() - __sizeOf<T>();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
...
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case cpp: __intrinsic_asm \"alignof($T0)\";\n")
SLANG_RAW("    case cuda: __intrinsic_asm \"alignof($T0)\";\n")
SLANG_RAW("    case llvm:\n")
SLANG_RAW("        return __sizeOf<Tuple<int8_t, T> >() - __sizeOf<T>();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("#line 3467 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_SPLICE(attrib
)
SLANG_RAW("\n")
...
SLANG_RAW("#line 3524 \"core.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("__generic<T>\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_Poison
)
SLANG_RAW(") // Note: attempting to actually *use* the result of `__declVal()` will always be invalid.\n")
...
SLANG_RAW("__generic<T>\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_IsCoopFloat
)
SLANG_RAW(")\n")
SLANG_RAW("bool __isCoopFloat_impl(T t);\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW("__generic<T>\n")
SLANG_RAW("[__unsafeForceInlineEarly]\n")
SLANG_RAW("bool __isCoopFloat()\n")
SLANG_RAW("{\n")
SLANG_RAW("    return __isCoopFloat_impl(__declVal<T>());\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
SLANG_RAW("[__unsafeForceInlineEarly]\n")
...
SLANG_RAW(")\n")
SLANG_RAW("internal T __irem<T>(T left, T right);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_FRem
)
SLANG_RAW(")\n")
SLANG_RAW("internal T __frem<T>(T left, T right);\n")
SLANG_RAW("\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("    [constref] T load(MemoryOrder order = MemoryOrder.Relaxed);\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically adds the given value to the stored value without returning\n")
SLANG_RAW("    /// the original value. On CUDA, maps to the PTX `red` instruction for\n")
SLANG_RAW("    /// potentially better performance than `add()`.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceAdd(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_add($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: add(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically subtracts the given value from the stored value without\n")
SLANG_RAW("    /// returning the original value. On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceSub(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_add($0, -($1), (int)$2)\";\n")
SLANG_RAW("        default: sub(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically computes the maximum of the stored value and the given value\n")
SLANG_RAW("    /// without returning the original value. On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceMax(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_max($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: max(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically computes the minimum of the stored value and the given value\n")
SLANG_RAW("    /// without returning the original value. On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceMin(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_min($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: min(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically performs a bitwise AND without returning the original value.\n")
SLANG_RAW("    /// On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceAnd(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_and($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: and(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically performs a bitwise OR without returning the original value.\n")
SLANG_RAW("    /// On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceOr(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_or($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: or(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically performs a bitwise XOR without returning the original value.\n")
SLANG_RAW("    /// On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceXor(T value, MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_xor($0, $1, (int)$2)\";\n")
SLANG_RAW("        default: xor(value, order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically increments the stored value without returning the original value.\n")
SLANG_RAW("    /// On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceInc(MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_inc($0, (int)$1)\";\n")
SLANG_RAW("        default: increment(order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("\n")
SLANG_RAW("    /// Atomically decrements the stored value without returning the original value.\n")
SLANG_RAW("    /// On CUDA, maps to the PTX `red` instruction.\n")
SLANG_RAW("    [require(atomic_reduce)]\n")
SLANG_RAW("    __cuda_sm_version(7.0)\n")
SLANG_RAW("    [ForceInline]\n")
SLANG_RAW("    [__ref] void reduceDec(MemoryOrder order = MemoryOrder.Relaxed)\n")
SLANG_RAW("    {\n")
SLANG_RAW("        __target_switch\n")
SLANG_RAW("        {\n")
SLANG_RAW("        case cuda: __intrinsic_asm \"__slang_atomic_reduce_dec($0, (int)$1)\";\n")
SLANG_RAW("        default: decrement(order);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("// @hidden:\n")
SLANG_RAW("__attributeTarget(DeclBase)\n")
SLANG_RAW("attribute_syntax [KnownBuiltin(name : int)] : KnownBuiltinAttribute;\n")
SLANG_RAW("\n")
SLANG_RAW("__attributeTarget(FunctionDeclBase)\n")
...
SLANG_RAW("\n")
SLANG_RAW("__generic<T>\n")
SLANG_RAW("typealias NodePayloadPtr = Ptr<T, Access::ReadWrite, (AddressSpace)")
...
SLANG_RAW("//@hidden:\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_position\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    [require(geometry)]\n")
SLANG_RAW("    get : float4;\n")
SLANG_RAW("\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(geometry)]\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    [require(domain)]\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    set : float4;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_depth\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    set : float;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_depthgreaterequal\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    set : float;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_depthlessequal\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    set : float;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_clipdistance\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : float;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_culldistance\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : float;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_target\n")
SLANG_RAW("{\n")
SLANG_RAW("    // SV_Target accepts any type - structs are flattened to multiple render targets\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_stencilref\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    set : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_coverage\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_innercoverage\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_dispatchthreadid\n")
SLANG_RAW("{\n")
SLANG_RAW("    // uint and uint2 overloads allow convenient access for 1D/2D dispatches.\n")
SLANG_RAW("    // HLSL requires uint3, but other backends (CUDA, SPIRV) extract appropriate\n")
SLANG_RAW("    // components. See dispatch-thread-id-extraction.slang.\n")
SLANG_RAW("    [require(compute)]\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    [require(amplification)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
SLANG_RAW("    [require(compute)]\n")
SLANG_RAW("    [require(mesh)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_groupindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(compute)]\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    [require(amplification)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_groupthreadid\n")
SLANG_RAW("{\n")
SLANG_RAW("    // uint and uint2 overloads allow convenient access for 1D/2D dispatches.\n")
SLANG_RAW("    // HLSL requires uint3, but other backends (CUDA, SPIRV) extract appropriate\n")
SLANG_RAW("    // components.\n")
SLANG_RAW("    [require(compute)]\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    [require(amplification)]\n")
SLANG_RAW("    get : uint;\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_vertexid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_instanceid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
SLANG_RAW("    // Vertex output + fragment input enables passing instance ID as a varying\n")
SLANG_RAW("    // Only works on SPIRV/GLSL, where we legalize it to a flat-interpolated user varying\n")
SLANG_RAW("    // See tests/bugs/gh-3087.slang for an example\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    set : uint;\n")
SLANG_RAW("\n")
SLANG_RAW("    [require(fragment)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_isfrontface\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : bool;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_sampleindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_pointcoord\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : float2;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_primitiveid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    [require(geometry)]\n")
SLANG_RAW("    [require(hull)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_viewportarrayindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_rendertargetarrayindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_domainlocation\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(domain)]\n")
SLANG_RAW("    get : float2;\n")
SLANG_RAW("\n")
SLANG_RAW("    [require(domain)]\n")
SLANG_RAW("    get : float3;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_outputcontrolpointid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_tessfactor\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    set : float;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_insidetessfactor\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    set : float;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_gsinstanceid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(geometry)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_pointsize\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(geometry)]\n")
SLANG_RAW("    [require(mesh)]\n")
...
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_drawindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    [require(amplification)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_deviceindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    [require(compute)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_wavelanecount\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    [require(domain)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_wavelaneindex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    [require(hull)]\n")
SLANG_RAW("    [require(domain)]\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_barycentrics\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : float3;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_startvertexlocation\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_startinstancelocation\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_raypayload\n")
SLANG_RAW("{\n")
SLANG_RAW("    // Ray payload can be any user-defined type\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_intersectionattributes\n")
SLANG_RAW("{\n")
SLANG_RAW("    // Intersection attributes can be any user-defined type\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_cullprimitive\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(mesh)]\n")
SLANG_RAW("    set : bool;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_fragsize\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : int2;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_fraginvocationcount\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : int;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_shadingrate\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_vulkanvertexid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_vulkaninstanceid\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get : uint;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("semantic sv_vulkansampleposition\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(fragment)]\n")
SLANG_RAW("    get : float2;\n")
SLANG_RAW("}\n")

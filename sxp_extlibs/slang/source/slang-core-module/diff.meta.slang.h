...
SLANG_RAW("SIMPLE_UNARY_DERIVATIVE_IMPL(exp2, exp2(dpx.p)* T(0.69314718055994530941723212145818))\n")
SLANG_RAW("// sin, sinh\n")
...
SLANG_RAW("SIMPLE_UNARY_DERIVATIVE_IMPL(log10, T(1.0) / (dpx.p * T(2.3025850929940456840179914546844)))\n")
SLANG_RAW("SIMPLE_UNARY_DERIVATIVE_IMPL(log2, T(1.0) / (dpx.p * T(0.69314718055994530941723212145818)))\n")

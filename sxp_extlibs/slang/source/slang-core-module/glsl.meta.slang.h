...
SLANG_RAW("//\n")
SLANG_RAW("\n")
SLANG_RAW("public typealias f16vec2 = half2;\n")
SLANG_RAW("public typealias f16vec3 = half3;\n")
SLANG_RAW("public typealias f16vec4 = half4;\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
SLANG_RAW("public typealias f16mat2x2 = matrix<half, 2, 2>;\n")
SLANG_RAW("public typealias f16mat2x3 = matrix<half, 2, 3>;\n")
SLANG_RAW("public typealias f16mat2x4 = matrix<half, 2, 4>;\n")
SLANG_RAW("\n")
SLANG_RAW("public typealias f16mat3x2 = matrix<half, 3, 2>;\n")
SLANG_RAW("public typealias f16mat3x3 = matrix<half, 3, 3>;\n")
SLANG_RAW("public typealias f16mat3x4 = matrix<half, 3, 4>;\n")
SLANG_RAW("\n")
SLANG_RAW("public typealias f16mat4x2 = matrix<half, 4, 2>;\n")
SLANG_RAW("public typealias f16mat4x3 = matrix<half, 4, 3>;\n")
SLANG_RAW("public typealias f16mat4x4 = matrix<half, 4, 4>;\n")
SLANG_RAW("\n")
SLANG_RAW("// Convenience aliases for square matrices\n")
SLANG_RAW("public typealias f16mat2 = f16mat2x2;\n")
SLANG_RAW("public typealias f16mat3 = f16mat3x3;\n")
SLANG_RAW("public typealias f16mat4 = f16mat4x4;\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
SLANG_RAW("internal in int _gl_DeviceIndex : SV_DeviceIndex;\n")
SLANG_RAW("public property int gl_DeviceIndex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [__unsafeForceInlineEarly]\n")
SLANG_RAW("    [require(glsl_spirv, GL_EXT_device_group)]\n")
SLANG_RAW("    get\n")
SLANG_RAW("    {\n")
SLANG_RAW("        return _gl_DeviceIndex;\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    get\n")
SLANG_RAW("    {\n")
SLANG_RAW("        return WorkgroupCount();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("internal in int __sv_VertexIndex : SV_VertexID;\n")
SLANG_RAW("internal in int __sv_VulkanInstanceIndex : SV_VulkanInstanceID;\n")
SLANG_RAW("internal in int __sv_VulkanVertexIndex : SV_VulkanVertexID;\n")
SLANG_RAW("\n")
...
SLANG_RAW("        case wgsl:\n")
SLANG_RAW("            return __sv_VulkanInstanceIndex;\n")
SLANG_RAW("        default:\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// SPIRV VertexIndex builtin for vertex shader\n")
SLANG_RAW("public property int gl_VertexIndex\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(vertex)]\n")
SLANG_RAW("    get\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("        case metal:\n")
SLANG_RAW("        case wgsl:\n")
SLANG_RAW("            return __sv_VulkanVertexIndex;\n")
SLANG_RAW("        default:\n")
SLANG_RAW("            return __sv_VertexIndex;\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("public in int gl_DrawID : SV_DrawIndex;\n")
SLANG_RAW("\n")
SLANG_RAW("public in int gl_FragInvocationCountEXT : SV_FragInvocationCount;\n")
SLANG_RAW("public in int2 gl_FragSizeEXT : SV_FragSize;\n")
SLANG_RAW("\n")
SLANG_RAW("public in float2 gl_SamplePosition : SV_VulkanSamplePosition;\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, sm_4_0_version)]\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, sm_4_0_version)]\n")
SLANG_RAW("public matrix<float, N, N> operator*=<let N:int>(inout matrix<float, N, N> m1, matrix<float, N, N> m2)\n")
SLANG_RAW("{\n")
SLANG_RAW("    m1 = mul(m2, m1);\n")
SLANG_RAW("    return m1;\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[OverloadRank(15)]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, sm_4_0_version)]\n")
SLANG_RAW("public matrix<half, N, N> operator*=<let N:int>(inout matrix<half, N, N> m1, matrix<half, N, N> m2)\n")
SLANG_RAW("{\n")
SLANG_RAW("    m1 = mul(m2, m1);\n")
SLANG_RAW("    return m1;\n")
SLANG_RAW("}\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, sm_4_0_version)]\n")
SLANG_RAW("public matrix<double, N, N> operator*=<let N:int>(inout matrix<double, N, N> m1, matrix<double, N, N> m2)\n")
SLANG_RAW("{\n")
SLANG_RAW("    m1 = mul(m2, m1);\n")
SLANG_RAW("    return m1;\n")
SLANG_RAW("}\n")
...
SLANG_RAW("[OverloadRank(15)]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, sm_4_0_version)]\n")
SLANG_RAW("public vector<T, C> operator*=<T:__BuiltinFloatingPointType, let C : int>(inout vector<T, C> v, matrix<T, C, C> m)\n")
SLANG_RAW("{\n")
SLANG_RAW("    v = mul(m, v);\n")
SLANG_RAW("    return v;\n")
SLANG_RAW("}\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[OverloadRank(15)]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_metal_spirv_wgsl_llvm)]\n")
...
SLANG_RAW("#line 393 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[OverloadRank(15)]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_metal_spirv_wgsl_llvm)]\n")
...
SLANG_RAW("#line 411 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_metal_spirv_llvm, sm_4_0_version)]\n")
...
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, shader5_sm_4_0)]\n")
...
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_metal_spirv_wgsl_llvm, pack_vector)]\n")
...
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, shader5_sm_5_0)]\n")
...
SLANG_RAW("    };\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        return asdouble(v.x, v.y);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[__readNone]\n")
...
SLANG_RAW("    };\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        uint lowbits = 0;\n")
SLANG_RAW("        uint highbits = 0;\n")
SLANG_RAW("        asuint(v, lowbits, highbits);\n")
SLANG_RAW("        return uvec2(lowbits, highbits);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 32-bit unsigned integer into 4 8-bit unsigned integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
SLANG_SPLICE(kIROp_BitCast
)
SLANG_RAW(")\n")
SLANG_RAW("public u8vec4 unpack8(uint32_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 32-bit signed integer into 4 8-bit signed integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public i8vec4 unpack8(int32_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 16-bit unsigned integer into 2 8-bit unsigned integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public u8vec2 unpack8(uint16_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 16-bit signed integer into 2 8-bit signed integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public i8vec2 unpack8(int16_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 32-bit unsigned integer into 2 16-bit unsigned integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public u16vec2 unpack16(uint32_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Unpack a 32-bit signed integer into 2 16-bit signed integers.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public i16vec2 unpack16(int32_t u);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Pack 2 16-bit unsigned integers into a 32-bit unsigned integer.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public uint32_t pack32(u16vec2 v);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Pack 2 16-bit signed integers into a 32-bit signed integer.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public int32_t pack32(i16vec2 v);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Pack 4 8-bit unsigned integers into a 32-bit unsigned integer.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public uint32_t pack32(u8vec4 v);\n")
SLANG_RAW("\n")
SLANG_RAW("/// Pack 4 8-bit signed integers into a 32-bit signed integer.\n")
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, pack_vector)]\n")
SLANG_RAW("__intrinsic_op(")
...
SLANG_RAW(")\n")
SLANG_RAW("public int32_t pack32(i8vec4 v);\n")
SLANG_RAW("\n")
SLANG_RAW("//\n")
...
SLANG_RAW("[__readNone]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_spirv_llvm, GLSL_400)]\n")
...
SLANG_RAW("    };\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        uint64_t result = uint64_t(x) * uint64_t(y);\n")
...
SLANG_RAW("    };\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        int64_t result = int64_t(x) * int64_t(y);\n")
...
SLANG_RAW("    };\n")
SLANG_RAW("    case llvm: __intrinsic_asm \"%result = call $TR @llvm.bitreverse($0)\";\n")
SLANG_RAW("    default:\n")
...
SLANG_RAW("\n")
SLANG_RAW("public typealias sampler1DShadow = Sampler1DShadow;\n")
SLANG_RAW("public typealias sampler2DShadow = Sampler2DShadow;\n")
SLANG_RAW("public typealias samplerCubeShadow = SamplerCubeShadow;\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
SLANG_RAW("public typealias sampler1DArrayShadow = Sampler1DArrayShadow;\n")
SLANG_RAW("public typealias sampler2DArrayShadow = Sampler2DArrayShadow;\n")
SLANG_RAW("public typealias samplerCubeArrayShadow = SamplerCubeArrayShadow;\n")
SLANG_RAW("\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    static_assert(__targetHasImplicitDerivatives(),\n")
SLANG_RAW("                 \"GLSL: textureQueryLod() may be invoked only on a stage that has implicit derivatives.\");\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    if (__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return __vectorReshape2<T.Element, 4>(sampler.Sample(p));\n")
SLANG_RAW("    else\n")
SLANG_RAW("        return __vectorReshape2<T.Element, 4>(sampler.SampleLevelZero(p));\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T:ITexelElement>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cpp_glsl_hlsl_spirv, texture_sm_4_0_fragment)]\n")
SLANG_RAW("public vector<T.Element,4> texture(Sampler1D<T> sampler, float p, float bias)\n")
SLANG_RAW("{\n")
SLANG_RAW("    if (__targetHasImplicitDerivatives())\n")
...
SLANG_RAW("        1, // isCombined\n")
SLANG_RAW("        format\n")
SLANG_RAW("    > sampler, vector<float,Shape.dimensions+isArray> p, float bias)\n")
SLANG_RAW("{\n")
SLANG_RAW("    if (__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return __vectorReshape2<T.Element,4>(sampler.SampleBias(p, bias));\n")
SLANG_RAW("    else\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(p.x, p.z);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
...
SLANG_RAW("\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(location, compareValue);\n")
SLANG_RAW("\n")
SLANG_RAW("    __requireComputeDerivative();\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("       return sampler.SampleCmpLevelZero(p.xy, p.z);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(p.xyz, p.w);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
SLANG_RAW("[ForceInline]\n")
...
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("public float texture(samplerCubeArrayShadow sampler, vec4 location, float compareValue, float bias)\n")
SLANG_RAW("{\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(location, compareValue);\n")
SLANG_RAW("\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(p, compare);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// -------------------\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return textureProjLod(sampler, p, 0.0f);\n")
SLANG_RAW("\n")
SLANG_RAW("    __requireComputeDerivative();\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("    }\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        return sampler.SampleCmpLevel(p.xy, p.z, lod);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
...
SLANG_RAW("    }\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        return sampler.SampleCmpLevel(p.xyz, p.w, lod);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
SLANG_RAW("public float textureLod(samplerCubeShadow sampler, vec4 p, float lod)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return sampler.SampleCmpLevel(p.xyz, p.w, lod);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
SLANG_RAW("public float textureLod(samplerCubeArrayShadow sampler, vec4 p, float compareValue, float lod)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return sampler.SampleCmpLevel(p, compareValue, lod);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_spirv, texture_shadowlod)]\n")
...
SLANG_RAW("    }\n")
SLANG_RAW("    default:\n")
SLANG_RAW("        return sampler.SampleCmpLevel(p.x, p.z, lod);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("[ForceInline]\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("        return __vectorReshape2<T.Element,4>(sampler.SampleLevelZero(p, offset));\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T:ITexelElement>\n")
SLANG_RAW("[ForceInline]\n")
...
SLANG_RAW("\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(location, compareValue, offset);\n")
SLANG_RAW("\n")
SLANG_RAW("    __requireComputeDerivative();\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(location, compareValue, vector<int,1>(offset));\n")
SLANG_RAW("\n")
SLANG_RAW("    __requireComputeDerivative();\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("    else\n")
SLANG_RAW("        return sampler.SampleCmpLevelZero(p.xyz, p.w, offset);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// -------------------\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    if (!__targetHasImplicitDerivatives())\n")
SLANG_RAW("        return textureProjLodOffset(sampler, p, 0.0f, offset);\n")
SLANG_RAW("\n")
SLANG_RAW("    __requireComputeDerivative();\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("        1, // isCombined\n")
SLANG_RAW("        format\n")
SLANG_RAW("    > sampler, vector<float,2+isArray> p, vector<int,2> offset, int comp = 0)\n")
SLANG_RAW("{\n")
SLANG_RAW("    switch (comp)\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("        1, // isCombined\n")
SLANG_RAW("        format\n")
SLANG_RAW("    > sampler, vector<float,2+isArray> p, float refZ, vector<int,2> offset)\n")
SLANG_RAW("{\n")
...
SLANG_RAW("#line 4556 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
        ...
        if(targetShape.isRect)
            continue;
SLANG_RAW("#line 4574 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("\n")
        ...
        if (targetShape.isMS)
        {
SLANG_RAW("#line 4632 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("            // readonly writeonly in GLSL means an object only allows information queries.\n")
SLANG_RAW("            [__readNone]\n")
SLANG_RAW("            [ForceInline]\n")
...
SLANG_RAW("#line 4652 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("        [ForceInline]\n")
SLANG_RAW("        [require(glsl_spirv, image_loadstore)]\n")
SLANG_RAW("        public ")
...
SLANG_RAW(" = OpAtomicExchange %ptr Device Relaxed $data\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW(" %ptr Device Relaxed $data\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW("        }\n")
        ...
        if (!targetType.isInt)
            continue;
SLANG_RAW("#line 4748 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("        [ForceInline]\n")
SLANG_RAW("        [require(glsl_spirv, image_loadstore)]\n")
SLANG_RAW("        public ")
...
SLANG_RAW(" = OpAtomicAnd %ptr Device Relaxed $data\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW(" = OpAtomicOr %ptr Device Relaxed $data\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW(" = OpAtomicXor %ptr Device Relaxed $data\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW(" = OpAtomicCompareExchange %ptr Device Relaxed Relaxed $data $compare\n")
SLANG_RAW("                };\n")
SLANG_RAW("            }\n")
SLANG_RAW("            }\n")
SLANG_RAW("        }\n")
...
SLANG_RAW("#line 4841 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("public typealias hitObjectEXT = HitObject;\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// While the glsl spec defines gl_PrimitiveID as an \"in int\",\n")
SLANG_RAW("// we need to use uint here and cast to an int below. This is due\n")
SLANG_RAW("// __gl_PrimitiveID being picked up as a global variable regardless\n")
SLANG_RAW("// of the stage used below. Using int __gl_PrimitiveID leads to a\n")
SLANG_RAW("// casting conflict due to the spirv implementation of PrimitiveIndex().\n")
SLANG_RAW("internal in uint __gl_PrimitiveID : SV_PrimitiveID;\n")
SLANG_RAW("\n")
...
SLANG_RAW("        default:\n")
SLANG_RAW("            return __intCast<int32_t>(__gl_PrimitiveID);\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("public property int gl_ClusterIDNV\n")
SLANG_RAW("{\n")
SLANG_RAW("    [require(glsl_spirv, raytracing_anyhit_closesthit)]\n")
SLANG_RAW("    get\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("        case glsl:\n")
SLANG_RAW("        {\n")
SLANG_RAW("            __requireTargetExtension(\"GL_NV_cluster_acceleration_structure\");\n")
SLANG_RAW("            __intrinsic_asm \"(gl_ClusterIDNV)\";\n")
SLANG_RAW("        }\n")
SLANG_RAW("        case spirv:\n")
SLANG_RAW("        {\n")
SLANG_RAW("            return spirv_asm\n")
...
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("// Constant to indicate that a cluster acceleration structure was not hit.\n")
SLANG_RAW("// Corresponds to VK_GEOMETRY_INSTANCE_CLUSTER_ID_NONE_NV in Vulkan\n")
SLANG_RAW("public static const int gl_ClusterIDNoneNV = -1;\n")
SLANG_RAW("\n")
...
SLANG_RAW("    constexpr int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    // Unified call to HitObject::TraceRay<int> - type checking handles location-based API\n")
SLANG_RAW("    hitObject = HitObject::TraceRay(\n")
SLANG_RAW("        topLevel,\n")
SLANG_RAW("        rayFlags,\n")
SLANG_RAW("        cullMask,\n")
SLANG_RAW("        sbtRecordOffset,\n")
SLANG_RAW("        sbtRecordStride,\n")
SLANG_RAW("        missIndex,\n")
SLANG_RAW("        RayDesc(origin, Tmin, direction, Tmax),\n")
SLANG_RAW("        payload);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_NV_shader_invocation_reorder_motion:\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("            payload);\n")
SLANG_RAW("    }\n")
SLANG_RAW("    case spvShaderInvocationReorderMotionNV:\n")
SLANG_RAW("    {\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
...
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_NV_shader_invocation_reorder:\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("    }\n")
SLANG_RAW("    case spvShaderInvocationReorderNV:\n")
SLANG_RAW("    {\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_NV_shader_invocation_reorder\";\n")
...
SLANG_RAW("\n")
SLANG_RAW("//\n")
SLANG_RAW("// GL_EXT_shader_invocation_reorder - Cross-vendor standard SER functions\n")
SLANG_RAW("//\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
SLANG_RAW("__glsl_extension(GL_EXT_shader_invocation_reorder)\n")
SLANG_RAW("__glsl_extension(GLSL_EXT_buffer_reference_uvec2)\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectTraceRayEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    accelerationStructureEXT topLevel,\n")
SLANG_RAW("    uint rayFlags,\n")
SLANG_RAW("    uint cullMask,\n")
SLANG_RAW("    uint sbtRecordOffset,\n")
...
SLANG_RAW("[require(spirv, ser_motion_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectTraceRayMotionEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    accelerationStructureEXT topLevel,\n")
SLANG_RAW("    uint rayFlags,\n")
SLANG_RAW("    uint cullMask,\n")
...
SLANG_RAW("    constexpr int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    // Unified call to HitObject::TraceMotionRay<int> - type checking handles location-based API\n")
SLANG_RAW("    hitObject = HitObject::TraceMotionRay(\n")
SLANG_RAW("        topLevel,\n")
SLANG_RAW("        rayFlags,\n")
SLANG_RAW("        cullMask,\n")
SLANG_RAW("        sbtRecordOffset,\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectRecordMissEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    uint rayFlags,\n")
...
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectRecordMissEXT($0, $1, $2, $3, $4, $5, $6)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvRecordMissEXT(hitObject, rayFlags, missShaderIndex, origin, Tmin, direction, Tmax);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_motion_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_motion_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectRecordMissMotionEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    uint rayFlags,\n")
SLANG_RAW("    uint missShaderIndex,\n")
SLANG_RAW("    vec3 origin,\n")
...
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder_motion:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectRecordMissMotionEXT($0, $1, $2, $3, $4, $5, $6, $7)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvRecordMissMotionEXT(hitObject, rayFlags, missShaderIndex, origin, Tmin, direction, Tmax, currentTime);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectRecordEmptyEXT(inout hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectRecordEmptyEXT($0)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvRecordEmptyEXT(hitObject);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("__glsl_extension(GLSL_EXT_buffer_reference_uvec2)\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void hitObjectExecuteShaderEXT(hitObjectEXT hitObject, int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        HitObject::__glslInvokeEXT(hitObject, payload);\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvExecuteShaderEXT(hitObject, payload);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public bool hitObjectIsEmptyEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.IsNop();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public bool hitObjectIsMissEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.IsMiss();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public bool hitObjectIsHitEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.IsHit();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public float hitObjectGetRayTMinEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetRayTMinEXT($0)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            result:$$float = OpHitObjectGetRayTMinEXT &hitObject\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public float hitObjectGetRayTMaxEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetRayTMaxEXT($0)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            result:$$float = OpHitObjectGetRayTMaxEXT &hitObject\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public uint hitObjectGetRayFlagsEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetRayFlagsEXT($0)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            result:$$uint = OpHitObjectGetRayFlagsEXT &hitObject\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public vec3 hitObjectGetWorldRayOriginEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetWorldRayOriginEXT($0)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            result:$$vec3 = OpHitObjectGetWorldRayOriginEXT &hitObject\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public vec3 hitObjectGetWorldRayDirectionEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetWorldRayDirectionEXT($0)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            result:$$vec3 = OpHitObjectGetWorldRayDirectionEXT &hitObject\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public vec3 hitObjectGetObjectRayOriginEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetObjectRayOrigin();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public vec3 hitObjectGetObjectRayDirectionEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetObjectRayDirection();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public matrix<float, 4, 3> hitObjectGetObjectToWorldEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetObjectToWorld();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public matrix<float, 4, 3> hitObjectGetWorldToObjectEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetWorldToObject();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public int hitObjectGetInstanceIdEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetInstanceID();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public int hitObjectGetInstanceCustomIndexEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetInstanceIndex();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public int hitObjectGetGeometryIndexEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetGeometryIndex();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public int hitObjectGetPrimitiveIndexEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetPrimitiveIndex();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public uint hitObjectGetHitKindEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetHitKind();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public float hitObjectGetCurrentTimeEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetCurrentTime();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectGetAttributesEXT<attr_t>(hitObjectEXT hitObject, out attr_t attributes)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
...
SLANG_RAW("            hitObject.__glslGetAttributesEXT(attributeLocation);\n")
SLANG_RAW("            attributes = __hitObjectAttributes<attr_t>();\n")
SLANG_RAW("        }\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        {\n")
...
SLANG_RAW("                OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("                OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("                OpHitObjectGetAttributesEXT &hitObject $attr;\n")
SLANG_RAW("            };\n")
SLANG_RAW("            attributes = *attr;\n")
SLANG_RAW("        }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public uint hitObjectGetShaderBindingTableRecordIndexEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetShaderTableIndex();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectSetShaderBindingTableRecordIndexEXT(inout hitObjectEXT hitObject, uint sbtRecordIndex)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectSetShaderBindingTableRecordIndexEXT($0, $1)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvSetShaderTableIndexEXT(hitObject, sbtRecordIndex);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public uint2 hitObjectGetShaderRecordBufferHandleEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return hitObject.GetShaderRecordBufferHandle();\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void reorderThreadEXT(uint coherenceHint, uint numCoherenceHintBitsFromLSB)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"reorderThreadWithHintEXT($0, $1)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvReorderThreadWithHintEXT(coherenceHint, numCoherenceHintBitsFromLSB);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void reorderThreadEXT(hitObjectEXT hitObject)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"reorderThreadWithHitObjectEXT($0)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvReorderThreadWithHitObjectEXT(hitObject);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void reorderThreadEXT(hitObjectEXT hitObject, uint coherenceHint, uint numCoherenceHintBitsFromLSB)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"reorderThreadWithHitObjectAndHintEXT($0, $1, $2)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvReorderThreadWithHitObjectAndHintEXT(hitObject, coherenceHint, numCoherenceHintBitsFromLSB);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectRecordFromQueryEXT(inout hitObjectEXT hitObject, rayQueryEXT rayQuery)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectRecordFromQueryEXT($0, $1)\";\n")
SLANG_RAW("    case spirv:\n")
SLANG_RAW("        HitObject::__spirvRecordFromQueryEXT(hitObject, rayQuery);\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_extension(GL_EXT_ray_tracing)\n")
...
SLANG_RAW("[require(glsl, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectGetIntersectionTriangleVertexPositionsEXT(hitObjectEXT hitObject, out vec3 positions[3])\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectGetIntersectionTriangleVertexPositionsEXT($0, $1)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
...
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            OpHitObjectGetIntersectionTriangleVertexPositionsEXT\n")
SLANG_RAW("                &hitObject\n")
SLANG_RAW("                &positions;\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void hitObjectReorderExecuteEXT(hitObjectEXT hitObject, int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectReorderExecuteEXT($0, $1)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            OpHitObjectReorderExecuteShaderEXT\n")
SLANG_RAW("                &hitObject\n")
SLANG_RAW("                __rayPayloadFromLocation(payload);\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void hitObjectReorderExecuteEXT(hitObjectEXT hitObject, uint coherenceHint, uint numCoherenceHintBitsFromLSB, int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectReorderExecuteEXT($0, $1, $2, $3)\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
...
SLANG_RAW("[require(glsl, ser_raygen)]\n")
SLANG_RAW("[require(spirv, ser_raygen)]\n")
SLANG_RAW("public void hitObjectTraceReorderExecuteEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    accelerationStructureEXT topLevel,\n")
SLANG_RAW("    uint rayFlags,\n")
SLANG_RAW("    uint cullMask,\n")
...
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectTraceReorderExecuteEXT\";\n")
SLANG_RAW("    case spvShaderInvocationReorderEXT:\n")
SLANG_RAW("    {\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            OpHitObjectTraceReorderExecuteEXT\n")
SLANG_RAW("                &hitObject\n")
SLANG_RAW("                /**/ $topLevel\n")
SLANG_RAW("                /**/ $rayFlags\n")
SLANG_RAW("                /**/ $cullMask\n")
...
SLANG_RAW("    vec3 direction,\n")
SLANG_RAW("    float Tmax,\n")
SLANG_RAW("    uint coherenceHint,\n")
SLANG_RAW("    uint numCoherenceHintBitsFromLSB,\n")
SLANG_RAW("    int payload)\n")
SLANG_RAW("{\n")
SLANG_RAW("    __target_switch\n")
SLANG_RAW("    {\n")
...
SLANG_RAW("                /**/ __rayPayloadFromLocation(payload)\n")
SLANG_RAW("                /**/ $coherenceHint\n")
SLANG_RAW("                /**/ $numCoherenceHintBitsFromLSB;\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("[require(glsl, ser_motion_raygen_closesthit_miss)]\n")
SLANG_RAW("[require(spirv, ser_motion_raygen_closesthit_miss)]\n")
SLANG_RAW("public void hitObjectTraceMotionReorderExecuteEXT(\n")
SLANG_RAW("    inout hitObjectEXT hitObject,\n")
SLANG_RAW("    accelerationStructureEXT topLevel,\n")
SLANG_RAW("    uint rayFlags,\n")
SLANG_RAW("    uint cullMask,\n")
...
SLANG_RAW("    {\n")
SLANG_RAW("    case _GL_EXT_shader_invocation_reorder_motion:\n")
SLANG_RAW("        __intrinsic_asm \"hitObjectTraceMotionReorderExecuteEXT\";\n")
SLANG_RAW("    case spvShaderInvocationReorderMotionEXT:\n")
SLANG_RAW("    {\n")
SLANG_RAW("        spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpExtension \"SPV_EXT_shader_invocation_reorder\";\n")
...
SLANG_RAW("            OpCapability ShaderInvocationReorderEXT;\n")
SLANG_RAW("            OpCapability RayTracingMotionBlurNV;\n")
SLANG_RAW("            OpHitObjectTraceMotionReorderExecuteEXT\n")
SLANG_RAW("                &hitObject\n")
SLANG_RAW("                /**/ $topLevel\n")
SLANG_RAW("                /**/ $rayFlags\n")
SLANG_RAW("                /**/ $cullMask\n")
...
SLANG_RAW("[require(cpp_cuda_glsl_hlsl_metal_spirv_wgsl, subgroup_ballot)]\n")
...
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetNumWaves();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetLaneEqMask();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    [require(cuda_glsl_hlsl_metal_spirv_wgsl, subgroup_ballot)]\n")
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetLaneGeMask();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    [require(cuda_glsl_hlsl_metal_spirv_wgsl, subgroup_ballot)]\n")
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetLaneGtMask();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    [require(cuda_glsl_hlsl_metal_spirv_wgsl, subgroup_ballot)]\n")
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetLaneLeMask();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("    [require(cuda_glsl_hlsl_metal_spirv_wgsl, subgroup_ballot)]\n")
SLANG_RAW("    get {\n")
SLANG_RAW("        return WaveGetLaneLtMask();\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("__glsl_extension(GL_KHR_shader_subgroup_arithmetic)\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_arithmetic)]\n")
SLANG_RAW("public T subgroupExclusiveMin(T value)\n")
SLANG_RAW("{\n")
SLANG_RAW("    shader_subgroup_preamble<T>();\n")
SLANG_RAW("    return WavePrefixMin(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType>\n")
SLANG_RAW("__spirv_version(1.3)\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    shader_subgroup_preamble<T>();\n")
SLANG_RAW("    return WavePrefixMax(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType>\n")
SLANG_RAW("__spirv_version(1.3)\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    shader_subgroup_preamble<T>();\n")
SLANG_RAW("    return WavePrefixBitAnd(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType>\n")
SLANG_RAW("__spirv_version(1.3)\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    shader_subgroup_preamble<T>();\n")
SLANG_RAW("    return WavePrefixBitOr(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType>\n")
SLANG_RAW("__spirv_version(1.3)\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    shader_subgroup_preamble<T>();\n")
SLANG_RAW("    return WavePrefixBitXor(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("// GL_KHR_shader_subgroup_arithmetic\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_hlsl_metal_spirv, subgroup_quad)]\n")
...
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("// GL_NV_shader_subgroup_partitioned\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedAddNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedAddNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedMulNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedMulNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedMinNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N: int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedMinNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedMaxNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedMaxNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedAndNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedAndNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedOrNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedOrNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedXorNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedXorNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("public T subgroupPartitionedInclusiveAddNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveAddNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedInclusiveMulNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveMulNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("public T subgroupPartitionedInclusiveMinNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveMinNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedInclusiveMaxNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveMaxNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedInclusiveAndNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveAndNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedInclusiveOrNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveOrNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedInclusiveXorNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedInclusiveXorNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixInclusiveBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveAddNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveAddNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveSum(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveMulNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveMulNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveProduct(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveMinNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveMinNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveMin(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveMaxNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinArithmeticType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(glsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveMaxNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveMax(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveAndNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveAndNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitAnd(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveOrNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveOrNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitOr(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
...
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public T subgroupPartitionedExclusiveXorNV(T value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinLogicalType, let N : int>\n")
SLANG_RAW("[ForceInline]\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public vector<T, N> subgroupPartitionedExclusiveXorNV(vector<T, N> value, uvec4 ballot)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMultiPrefixExclusiveBitXor(value, ballot);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("__generic<T : __BuiltinType>\n")
SLANG_RAW("[require(cuda_glsl_hlsl_spirv, subgroup_partitioned)]\n")
SLANG_RAW("public uvec4 subgroupPartitionNV(T value)\n")
SLANG_RAW("{\n")
SLANG_RAW("    return WaveMatch(value);\n")
SLANG_RAW("}\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
{
SLANG_RAW("#line 9704 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
if(item.isFloat)
    continue;
SLANG_RAW("#line 9773 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("__glsl_version(430)\n")
...
SLANG_RAW("#line 9843 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicIIncrement $$uint result $c Device AtomicCounterMemory\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            %discardedValue:$$uint = OpAtomicIDecrement $c Device AtomicCounterMemory;\n")
SLANG_RAW("            OpLoad $$uint result $c\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicIAdd $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicISub $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicUMin $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicUMax $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicAnd $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicOr $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicXor $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicExchange $$uint result $c Device AtomicCounterMemory $data\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("        return spirv_asm\n")
SLANG_RAW("        {\n")
SLANG_RAW("            OpAtomicCompareExchange $$uint result $c Device AtomicCounterMemory AtomicCounterMemory $data $compare\n")
SLANG_RAW("        };\n")
SLANG_RAW("    }\n")
SLANG_RAW("    }\n")
SLANG_RAW("}\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    return fwidth_fine(p);\n")
SLANG_RAW("}\n")
SLANG_RAW("__generic<let N : int>\n")
SLANG_RAW("[__NoSideEffect]\n")
SLANG_RAW("[ForceInline]\n")
...
SLANG_RAW("{\n")
SLANG_RAW("    return fwidth_coarse(p);\n")
SLANG_RAW("}\n")
SLANG_RAW("__generic<let N : int>\n")
SLANG_RAW("[__NoSideEffect]\n")
SLANG_RAW("[ForceInline]\n")
...
{
SLANG_RAW("#line 10574 \"glsl.meta.slang\"")
SLANG_RAW("\n")
...
SLANG_RAW("#line 10588 \"glsl.meta.slang\"")
SLANG_RAW("\n")
SLANG_RAW("\n")
SLANG_RAW("    __generic<T>\n")
SLANG_RAW("    [__NoSideEffect]\n")

...
// core class traits
//============================================================================
PFC_SET_TYPE_TRAIT2(uint128_t, is_type_pod, is_type_pod_stream, true);
PFC_SET_TYPE_TRAIT(uint128_t, is_type_class, false);
...
PFC_SET_TYPE_TRAIT(raw_data, is_type_pod_move, true);
//----------------------------------------------------------------------------

...
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_mask<mask_size_, mask_pos_, uint128_t, dw32_idx_>
{
  static const uint128_t res;
};
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
const uint128_t meta_mask<mask_size_, mask_pos_, uint128_t, dw32_idx_>::res={uint64_t(uint32_t(meta_mask<mask_size_, mask_pos_, uint32_t, dw32_idx_+0>::res))|(uint64_t(uint32_t(meta_mask<mask_size_, mask_pos_, uint32_t, dw32_idx_+1>::res))<<32),
                                                                             uint64_t(uint32_t(meta_mask<mask_size_, mask_pos_, uint32_t, dw32_idx_+2>::res))|(uint64_t(uint32_t(meta_mask<mask_size_, mask_pos_, uint32_t, dw32_idx_+3>::res))<<32)};
//----------------------------------------------------------------------------
...
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
struct meta_imask<mask_size_, mask_pos_, uint128_t, dw32_idx_>
{
  static const uint128_t res;
};
template<unsigned mask_size_, unsigned mask_pos_, unsigned dw32_idx_>
const uint128_t meta_imask<mask_size_, mask_pos_, uint128_t, dw32_idx_>::res={~meta_mask<mask_size_, mask_pos_, uint128_t, dw32_idx_>::res.lo,
                                                                              ~meta_mask<mask_size_, mask_pos_, uint128_t, dw32_idx_>::res.hi};
//----------------------------------------------------------------------------

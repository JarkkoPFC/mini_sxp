...
PFC_INLINE const char *str_find_whitespace(const char*, const char *extra_whitespace_chars_);
PFC_INLINE const wchar_t *str_find_whitespace(const wchar_t*);
PFC_INLINE const wchar_t *str_find_whitespace(const wchar_t*, const wchar_t *extra_whitespace_chars_);
PFC_INLINE char *str_find_whitespace(char*);
PFC_INLINE char *str_find_whitespace(char*, const char *extra_whitespace_chars_);
PFC_INLINE wchar_t *str_find_whitespace(wchar_t*);
PFC_INLINE wchar_t *str_find_whitespace(wchar_t*, const wchar_t *extra_whitespace_chars_);
// reverse search
const char *str_rfind(const char*, char, usize_t num_chars_);
const wchar_t *str_rfind(const wchar_t*, wchar_t, usize_t num_chars_);
char *str_rfind(char*, char, usize_t num_chars_);
wchar_t *str_rfind(wchar_t*, wchar_t, usize_t num_chars_);
const char *str_rfind(const char*, const char *chars_, usize_t num_chars_);
const wchar_t *str_rfind(const wchar_t*, const wchar_t *chars_, usize_t num_chars_);
char *str_rfind(char*, const char *chars_, usize_t num_chars_);
wchar_t *str_rfind(wchar_t*, const wchar_t *chars_, usize_t num_chars_);
const char *str_rifind(const char*, char, usize_t num_chars_);
const wchar_t *str_rifind(const wchar_t*, wchar_t, usize_t num_chars_);
char *str_rifind(char*, char, usize_t num_chars_);
wchar_t *str_rifind(wchar_t*, wchar_t, usize_t num_chars_);
const char *str_rifind(const char*, const char *chars_, usize_t num_chars_);
const wchar_t *str_rifind(const wchar_t*, const wchar_t *chars_, usize_t num_chars_);
char *str_rifind(char*, const char *chars_, usize_t num_chars_);
wchar_t *str_rifind(wchar_t*, const wchar_t *chars_, usize_t num_chars_);
const char *str_rfind_substr(const char*, const char *substr_, usize_t num_chars_);
const wchar_t *str_rfind_substr(const wchar_t*, const wchar_t *substr_, usize_t num_chars_);
char *str_rfind_substr(char*, const char *substr_, usize_t num_chars_);
wchar_t *str_rfind_substr(wchar_t*, const wchar_t *substr_, usize_t num_chars_);
const char *str_rifind_substr(const char*, const char *substr_, usize_t num_chars_);
const wchar_t *str_rifind_substr(const wchar_t*, const wchar_t *substr_, usize_t num_chars_);
char *str_rifind_substr(char*, const char *substr_, usize_t num_chars_);
wchar_t *str_rifind_substr(wchar_t*, const wchar_t *substr_, usize_t num_chars_);
const char *str_rfind_next_line(const char*, usize_t num_chars_);
const wchar_t *str_rfind_next_line(const wchar_t*, usize_t num_chars_);
char *str_rfind_next_line(char*, usize_t num_chars_);
wchar_t *str_rfind_next_line(wchar_t*, usize_t num_chars_);
PFC_INLINE const char *str_rfind_whitespace(const char*, usize_t num_chars_);
PFC_INLINE const char *str_rfind_whitespace(const char*, const char *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE const wchar_t *str_rfind_whitespace(const wchar_t*, usize_t num_chars_);
PFC_INLINE const wchar_t *str_rfind_whitespace(const wchar_t*, const wchar_t *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE char *str_rfind_whitespace(char*, usize_t num_chars_);
PFC_INLINE char *str_rfind_whitespace(char*, const char *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE wchar_t *str_rfind_whitespace(wchar_t*, usize_t num_chars_);
PFC_INLINE wchar_t *str_rfind_whitespace(wchar_t*, const wchar_t *extra_whitespace_chars_, usize_t num_chars_);
// skipping
PFC_INLINE const char *str_skip_whitespace(const char*);
const char *str_skip_whitespace(const char*, const char *extra_whitespace_chars_);
PFC_INLINE const wchar_t *str_skip_whitespace(const wchar_t*);
const wchar_t *str_skip_whitespace(const wchar_t*, const wchar_t *extra_whitespace_chars_);
PFC_INLINE char *str_skip_whitespace(char*);
char *str_skip_whitespace(char*, const char *extra_whitespace_chars_);
PFC_INLINE wchar_t *str_skip_whitespace(wchar_t*);
wchar_t *str_skip_whitespace(wchar_t*, const wchar_t *extra_whitespace_chars_);
// reverse skipping
PFC_INLINE const char *str_rskip_whitespace(const char*, usize_t num_chars_);
const char *str_rskip_whitespace(const char*, const char *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE const wchar_t *str_rskip_whitespace(const wchar_t*, usize_t num_chars_);
const wchar_t *str_rskip_whitespace(const wchar_t*, const wchar_t *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE char *str_rskip_whitespace(char*, usize_t num_chars_);
char *str_rskip_whitespace(char*, const char *extra_whitespace_chars_, usize_t num_chars_);
PFC_INLINE wchar_t *str_rskip_whitespace(wchar_t*, usize_t num_chars_);
wchar_t *str_rskip_whitespace(wchar_t*, const wchar_t *extra_whitespace_chars_, usize_t num_chars_);
// manipulation
...
char *str_tokenize_words(char*);
char *str_tokenize_words(char*, const char *extra_word_separators_);
wchar_t *str_tokenize_words(wchar_t*);
wchar_t *str_tokenize_words(wchar_t*, const wchar_t *extra_word_separators_);

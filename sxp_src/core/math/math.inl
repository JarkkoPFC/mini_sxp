...
template<typename T>
PFC_INLINE vec2<T> cycle(const vec2<T> &v_, const vec2<T> &cycle_)
{
  // component-wise cycle
  return vec2<T>(std::fmod(v_.x, cycle_.x)+(v_.x<0?cycle_.x:0),
                 std::fmod(v_.y, cycle_.y)+(v_.y<0?cycle_.y:0));
}
//----
...
template<typename T>
PFC_INLINE vec3<T> cycle(const vec3<T> &v_, const vec3<T> &cycle_)
{
  // component-wise cycle
  return vec3<T>(std::fmod(v_.x, cycle_.x)+(v_.x<0?cycle_.x:0),
                 std::fmod(v_.y, cycle_.y)+(v_.y<0?cycle_.y:0),
                 std::fmod(v_.z, cycle_.z)+(v_.z<0?cycle_.z:0));
}
//----
...
template<typename T>
PFC_INLINE vec4<T> cycle(const vec4<T> &v_, const vec4<T> &cycle_)
{
  // component-wise cycle
  return vec4<T>(std::fmod(v_.x, cycle_.x)+(v_.x<0?cycle_.x:0),
                 std::fmod(v_.y, cycle_.y)+(v_.y<0?cycle_.y:0),
                 std::fmod(v_.z, cycle_.z)+(v_.z<0?cycle_.z:0),
                 std::fmod(v_.w, cycle_.w)+(v_.w<0?cycle_.w:0));
}
//----
...
template<typename T>
PFC_INLINE quat<T> cycle(const quat<T> &q_, const quat<T> &cycle_)
{
  // component-wise cycle
  return quat<T>(std::fmod(q_.x, cycle_.x)+(q_.x<0?cycle_.x:0),
                 std::fmod(q_.y, cycle_.y)+(q_.y<0?cycle_.y:0),
                 std::fmod(q_.z, cycle_.z)+(q_.z<0?cycle_.z:0),
                 std::fmod(q_.w, cycle_.w)+(q_.w<0?cycle_.w:0));
}
//----
...
template<typename T>
PFC_INLINE complex<T> cycle(const complex<T> &c_, const complex<T> &cycle_)
{
  // component-wise cycle
  return complex<T>(std::fmod(c_.real, cycle_.real)+(c_.real<0?cycle_.real:0),
                    std::fmod(c_.imag, cycle_.imag)+(c_.imag<0?cycle_.imag:0));
}
//----

...
// SH2 vector ops
template<typename T> PFC_INLINE void operator+=(shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE void operator+=(shvec2<T>&, T);
template<typename T> PFC_INLINE void operator-=(shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE void operator-=(shvec2<T>&, T);
template<typename T> PFC_INLINE void operator*=(shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE void operator*=(shvec2<T>&, T);
template<typename T> PFC_INLINE void operator*=(shvec2<T>&, const shmat2<T>&);
template<typename T> PFC_INLINE void operator/=(shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE void operator/=(shvec2<T>&, T);
template<typename T> PFC_INLINE shvec2<T> operator+(const shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator+(const shvec2<T>&, T);
template<typename T> PFC_INLINE shvec2<T> operator+(T, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator-(const shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator-(const shvec2<T>&, T);
template<typename T> PFC_INLINE shvec2<T> operator-(T, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator*(const shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator*(const shvec2<T>&, T);
template<typename T> PFC_INLINE shvec2<T> operator*(T, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator*(const shvec2<T>&, const shmat2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator*(const shmat2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator/(const shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE shvec2<T> operator/(const shvec2<T>&, T);
template<typename T> PFC_INLINE shvec2<T> operator/(T, const shvec2<T>&);
template<typename T> PFC_INLINE T sh_dot(const shvec2<T>&, const shvec2<T>&);
template<typename T> PFC_INLINE void sh_dir(shvec2<T>&, const vec3<T>&);
template<typename T, typename U> shvec2<T> sh_product(const shvec2<T>&, const shvec2<U>&);
// SH3 vector ops
template<typename T> PFC_INLINE void operator+=(shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE void operator+=(shvec3<T>&, T);
template<typename T> PFC_INLINE void operator-=(shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE void operator-=(shvec3<T>&, T);
template<typename T> PFC_INLINE void operator*=(shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE void operator*=(shvec3<T>&, T);
template<typename T> PFC_INLINE void operator*=(shvec3<T>&, const shmat3<T>&);
template<typename T> PFC_INLINE void operator/=(shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE void operator/=(shvec3<T>&, T);
template<typename T> PFC_INLINE shvec3<T> operator+(const shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator+(const shvec3<T>&, T);
template<typename T> PFC_INLINE shvec3<T> operator+(T, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator-(const shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator-(const shvec3<T>&, T);
template<typename T> PFC_INLINE shvec3<T> operator-(T, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator*(const shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator*(const shvec3<T>&, T);
template<typename T> PFC_INLINE shvec3<T> operator*(T, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator*(const shvec3<T>&, const shmat3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator*(const shmat3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator/(const shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE shvec3<T> operator/(const shvec3<T>&, T);
template<typename T> PFC_INLINE shvec3<T> operator/(T, const shvec3<T>&);
template<typename T> PFC_INLINE T sh_dot(const shvec3<T>&, const shvec3<T>&);
template<typename T> PFC_INLINE void sh_dir(shvec3<T>&, const vec3<T>&);
template<typename T, typename U> shvec3<T> sh_product(const shvec3<T>&, const shvec3<U>&);
// ZH2 vector ops
template<typename T> PFC_INLINE void operator+=(zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE void operator+=(zhvec2<T>&, T);
template<typename T> PFC_INLINE void operator-=(zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE void operator-=(zhvec2<T>&, T);
template<typename T> PFC_INLINE void operator*=(zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE void operator*=(zhvec2<T>&, T);
template<typename T> PFC_INLINE void operator/=(zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE void operator/=(zhvec2<T>&, T);
template<typename T> PFC_INLINE zhvec2<T> operator+(const zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE zhvec2<T> operator+(const zhvec2<T>&, T);
template<typename T> PFC_INLINE zhvec2<T> operator+(T, const zhvec2<T>&);
template<typename T> PFC_INLINE zhvec2<T> operator-(const zhvec2<T>&, const zhvec2<T>&);
template<typename T> PFC_INLINE zhvec2<T> operator-(const zhvec2<T>&, T);
template<typename T> PFC_INLINE zhvec2<T> operator-(T, const zhvec2<T>&);
template<typename T> PFC_INLINE zhvec2<T> operator*(const zhvec2<T>&, const zhvec2<T>&);
...
template<typename T> PFC_INLINE zhvec2<T> operator/(const zhvec2<T>&, T);
template<typename T> PFC_INLINE zhvec2<T> operator/(T, const zhvec2<T>&);
template<typename T> PFC_INLINE T sh_dot(const zhvec2<T>&, const zhvec2<T>&);
// ZH3 vector ops
template<typename T> PFC_INLINE void operator+=(zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE void operator+=(zhvec3<T>&, T);
template<typename T> PFC_INLINE void operator-=(zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE void operator-=(zhvec3<T>&, T);
template<typename T> PFC_INLINE void operator*=(zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE void operator*=(zhvec3<T>&, T);
template<typename T> PFC_INLINE void operator/=(zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE void operator/=(zhvec3<T>&, T);
template<typename T> PFC_INLINE zhvec3<T> operator+(const zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE zhvec3<T> operator+(const zhvec3<T>&, T);
template<typename T> PFC_INLINE zhvec3<T> operator+(T, const zhvec3<T>&);
template<typename T> PFC_INLINE zhvec3<T> operator-(const zhvec3<T>&, const zhvec3<T>&);
template<typename T> PFC_INLINE zhvec3<T> operator-(const zhvec3<T>&, T);
template<typename T> PFC_INLINE zhvec3<T> operator-(T, const zhvec3<T>&);
template<typename T> PFC_INLINE zhvec3<T> operator*(const zhvec3<T>&, const zhvec3<T>&);
...
template<typename T> PFC_INLINE zhvec3<T> operator/(const zhvec3<T>&, T);
template<typename T> PFC_INLINE zhvec3<T> operator/(T, const zhvec3<T>&);
template<typename T> PFC_INLINE T sh_dot(const zhvec3<T>&, const zhvec3<T>&);
//----------------------------------------------------------------------------

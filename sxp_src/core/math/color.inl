...
template<typename T> PFC_INLINE color_rgb<T> lerp(const color_rgb<T> &c0_,
                                                   const color_rgb<T> &c1_,
...
template<typename T> PFC_INLINE color_rgba<T> lerp(const color_rgba<T> &c0_,
                                                   const color_rgba<T> &c1_,
...
template<typename T> PFC_INLINE color_xyz<T> lerp(const color_xyz<T> &c0_,
                                                   const color_xyz<T> &c1_,
...
template<typename T> PFC_INLINE color_xyza<T> lerp(const color_xyza<T> &c0_,
                                                   const color_xyza<T> &c1_,
...
template<typename T> PFC_INLINE color_yiq<T> lerp(const color_yiq<T> &c0_,
                                                   const color_yiq<T> &c1_,
...
template<typename T> PFC_INLINE color_yiqa<T> lerp(const color_yiqa<T> &c0_,
                                                   const color_yiqa<T> &c1_,
...
template<typename T> PFC_INLINE color_hsv<T> lerp(const color_hsv<T> &c0_,
                                                   const color_hsv<T> &c1_,
...
template<typename T> PFC_INLINE color_hsva<T> lerp(const color_hsva<T> &c0_,
                                                   const color_hsva<T> &c1_,

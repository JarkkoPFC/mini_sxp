...
struct numeric_type<int64_t>
{
  ...
  static PFC_INLINE int64_t range_min()  {return int64_t((uint64_t(-1)>>1)+1);}
  static PFC_INLINE int64_t range_max()  {return int64_t(uint64_t(-1)>>1);}
...
struct numeric_type<uint64_t>
{
  ...
  static PFC_INLINE int64_t range_min()  {return 0;}
  static PFC_INLINE int64_t range_max()  {return uint64_t(-1);}
  static PFC_INLINE int64_t zero()       {return 0;}
...
//============================================================================
// numeric_type<uint128_t>
//============================================================================
template<>
struct numeric_type<uint128_t>
{
  // type properties
  enum
  {
  ...
  static PFC_INLINE uint128_t range_min()  {uint128_t v={0, 0}; return v;}
  static PFC_INLINE uint128_t range_max()  {uint128_t v={uint64_t(-1), uint64_t(-1)}; return v;}
  static PFC_INLINE uint128_t zero()       {uint128_t v={0, 0}; return v;}
  static PFC_INLINE uint128_t float_one()  {uint128_t v={uint64_t(-1), uint64_t(-1)}; return v;}
};
//----------------------------------------------------------------------------

...
template<typename T> PFC_INLINE T lerp(T a_, T b_, float t_);  // linear interpolation of scalars: f(t=0)=a_, f(t=1)=b_
...
template<typename T> PFC_INLINE vec2<T> cycle(const vec2<T>&, const vec2<T>& cycle_);                       // component-wise cycle
...
template<typename T> PFC_INLINE vec3<T> cycle(const vec3<T>&, const vec3<T> &cycle_);                       // component-wise cycle
...
template<typename T> PFC_INLINE vec4<T> cycle(const vec4<T>&, const vec4<T> &cycle_);                       // component-wise cycle
...
template<typename T> PFC_INLINE mat22<T> lerp(const mat22<T> &m0_, const mat22<T> &m1_, float t_);          // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
template<typename T> PFC_INLINE void lerp(mat22<T> &res_,                                                   // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
                                          const mat22<T> &m0_, const mat22<T> &m1_, float t_);
...
template<typename T> PFC_INLINE mat33<T> lerp(const mat33<T> &m0_, const mat33<T> &m1_, float t_);          // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
template<typename T> PFC_INLINE void lerp(mat33<T> &res_,                                                   // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
                                          const mat33<T> &m0_, const mat33<T> &m1_, float t_);
...
template<typename T> PFC_INLINE mat44<T> lerp(const mat44<T> &m0_, const mat44<T> &m1_, float t_);          // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
template<typename T> PFC_INLINE void lerp(mat44<T> &res_,                                                   // linear interpolation of matrices: f(t=0)=m0, f(t=1)=m1
                                          const mat44<T> &m0_, const mat44<T> &m1_, float t_); 
...
template<typename T> PFC_INLINE quat<T> cycle(const quat<T>&, const quat<T> &cycle_);                       // component-wise cycle
...
template<typename T> PFC_INLINE quat<T> nlerp(const quat<T> &q0_, const quat<T> &q1_, float t_);            // normalized linear quaternion interpolation: f(t=0)=q0/|q0|, f(t=1)=q1/|q1|
template<typename T> PFC_INLINE quat<T> nlerp_z(const quat<T> &q0_, const quat<T> &q1_, float t_);          // normalized linear quaternion interpolation: f(t=0)=q0/|q0|, f(t=1)=q1/|q1|. if |q|=0, return q=[v=0, w=1]
template<typename T> PFC_INLINE quat<T> slerp(const quat<T> &q0_, const quat<T> &q1_, float t_);            // spherical linear quaternion interpolation: f(t=0)=q0, f(t=1)=q1
...
template<typename T> PFC_INLINE complex<T> cycle(const complex<T>&, const complex<T> &cycle_);              // component-wise cycle
...
template<typename T> PFC_INLINE complex<T> nlerp(const complex<T> &c0_, const complex<T> &c1_, float t_);   // normalized linear complex number interpolation: f(t=0)=c0/|c0|, f(t=1)=c1/|c1|
template<typename T> PFC_INLINE complex<T> nlerp_z(const complex<T> &c0_, const complex<T> &c1_, float t_); // normalized linear complex number interpolation: f(t=0)=c0/|c0|, f(t=1)=c1/|c1|. if |c|=0, return c=[0, 0]
...
template<typename T>
struct mat33
{ PFC_MONO(mat33) {PFC_MVAR3(x, y, z);}
  typedef T type_t;
  typedef typename math<T>::scalar_t scalar_t;
...
template<typename T>
struct mat44
{ PFC_MONO(mat44) {PFC_MVAR4(x, y, z, w);}
  typedef T type_t;
  typedef typename math<T>::scalar_t scalar_t;
...
template<typename T>
struct complex
{ PFC_MONO(complex) {PFC_MVAR2(real, imag);}
  typedef T type_t;
  typedef typename math<T>::scalar_t scalar_t;
  enum {dim=2};
  //--------------------------------------------------------------------------
